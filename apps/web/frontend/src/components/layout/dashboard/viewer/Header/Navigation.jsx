...
const Navigation = () => {
  ...
  const navigationItems = [
    { label: t("viewerdashboardnavs.navigation.home"), path: "/" },
    { label: t("viewerdashboardnavs.navigation.tvShows"), path: "/tv" },
    { label: t("viewerdashboardnavs.navigation.movies"), path: "/movies" },
    { label: t("viewerdashboardnavs.navigation.newPopular"), path: "/new" },
    { label: t("viewerdashboardnavs.navigation.myList"), path: "/my-list" },
    { label: t("viewerdashboardnavs.navigation.browse"), path: "/browse" },
  ];
        ...
        {navigationOpen && (
          <div className="absolute left-0 top-12 w-64 bg-gray-800 border border-gray-700 rounded-xl shadow-2xl overflow-hidden z-50">
            <div className="p-3 border-b border-gray-700 bg-gradient-to-r from-gray-800 to-gray-900">
              <h3 className="text-white font-semibold text-sm">{t("viewerdashboardnavs.navigation.browse")}</h3>
            </div>
