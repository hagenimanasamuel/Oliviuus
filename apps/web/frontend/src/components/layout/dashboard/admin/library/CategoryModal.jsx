...
import { X, Save, Folder, Eye, EyeOff, Hash, Tag, ChevronDown } from 'lucide-react';
import api from '../../../../../api/axios';

const CategoryModal = ({ category, parentCategories, onClose, onSave }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (category) {
        response = await api.put(`/categories/${category.id}`, formData);
      } else {
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400 text-sm">
                {category ? 'Update category details' : 'Add a new content category'}
              </p>
            </div>
          </div>
          <button
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6 overflow-y-auto max-h-[calc(90vh-140px)]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                placeholder="e.g., Movies, Series, Documentaries"
              />
          ...
          <div className="space-y-4 pt-4 border-t border-gray-200 dark:border-gray-700">
            ...
            <div className="space-y-2">
              ...
              />
              <p className="text-gray-500 dark:text-gray-400 text-xs">
                If empty, category name will be used.
              </p>
            </div>
