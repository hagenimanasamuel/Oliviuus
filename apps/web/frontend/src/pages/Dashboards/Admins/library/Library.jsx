...
import { Film, Tag, MoreHorizontal, Users } from "lucide-react";
import clsx from "clsx";

// Lazy-loaded external pages
const AllContent = React.lazy(() => import("./AllContent"));
const GenresCategories = React.lazy(() => import("./GenresCategories"));
const PeopleManagement = React.lazy(() => import("./PeopleManagement"));
