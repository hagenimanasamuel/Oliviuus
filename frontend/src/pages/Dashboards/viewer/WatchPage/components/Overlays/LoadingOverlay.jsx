// components/Overlays/LoadingOverlay.jsx
    ...
    <div className="absolute inset-0 flex items-center justify-center z-30 bg-black/60">
      <div className="text-center">
        ...
        <p className="text-white text-sm font-medium">
          {message || (isBuffering ? 'Buffering...' : 'Loading...')}
        </p>
        {message && (
          <p className="text-gray-400 text-xs mt-2">Please wait while we prepare the content</p>
        )}
      </div>
    </div>
  );
