...
const LandingPageContents = ({
  ...
  const sections = [
    {
      key: 'popular',
      title: t('landing.sections.popular', 'Popular in Rwanda'),
      subtitle: t('landing.sections.popularSubtitle', 'Top picks loved by Rwandan viewers'),
      icon: Sparkles,
    ...
    {
      key: 'trending',
      title: t('landing.sections.trending', 'Trending Now'),
      subtitle: t('landing.sections.trendingSubtitle', 'What everyone is watching'),
      icon: TrendingUp,
    ...
    {
      key: 'recent',
      title: t('landing.sections.recent', 'New Releases'),
      subtitle: t('landing.sections.recentSubtitle', 'Fresh content just added'),
      icon: ClockIcon,
                ...
                {section.content.length > 0 ? (
                  section.content.map((content) => (
                    <div
                      ...
                      className="flex-shrink-0 w-32 xs:w-36 sm:w-40 md:w-44 lg:w-48 xl:w-52"
                    >
                      <ContentCard
                        content={content}
                        onPlay={onPlay}
                  ...
                  <div className="flex flex-col items-center justify-center w-full py-8 lg:py-10 text-center">
                    ...
                    <h3 className="text-white text-base lg:text-lg font-semibold mb-1.5">
                      {t('landing.emptyState.noContentTitle', 'No content available')}
                    </h3>
                    <p className="text-gray-400 text-xs lg:text-sm max-w-xs">
                      {t('landing.emptyState.noContentMessage', 'Check back later for new additions.')}
                    </p>
                  </div>
                )}
              </div>
