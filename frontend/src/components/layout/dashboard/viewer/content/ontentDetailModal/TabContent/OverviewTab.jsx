    ...
    <div className="space-y-8">
      ...
      <div className="bg-white/5 rounded-2xl border border-white/10 p-6">
        ...
        <p className="text-gray-300 leading-relaxed text-lg">
          {contentData?.description || contentData?.short_description || 'No description available.'}
        </p>
      </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-gradient-to-br from-yellow-500/10 to-yellow-600/5 rounded-xl border border-yellow-500/20 p-4 text-center">
          ...
          <h4 className="text-sm font-semibold text-yellow-400 mb-1">Rating</h4>
        ...
        {contentData?.duration_minutes && (
          <div className="bg-gradient-to-br from-blue-500/10 to-blue-600/5 rounded-xl border border-blue-500/20 p-4 text-center">
            ...
            <h4 className="text-sm font-semibold text-blue-400 mb-1">Duration</h4>
        ...
        <div className="bg-gradient-to-br from-green-500/10 to-green-600/5 rounded-xl border border-green-500/20 p-4 text-center">
          ...
          <h4 className="text-sm font-semibold text-green-400 mb-1">Age Rating</h4>
        ...
        <div className="bg-gradient-to-br from-purple-500/10 to-purple-600/5 rounded-xl border border-purple-500/20 p-4 text-center">
          ...
          <h4 className="text-sm font-semibold text-purple-400 mb-1">Type</h4>
          <p className="text-white font-bold text-xl capitalize">{contentData?.content_type || 'Movie'}</p>
        </div>
      </div>
      ...
      {getContentWarnings().length > 0 && (
        <div className="bg-yellow-500/10 border border-yellow-500/20 rounded-2xl p-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h4 className="text-xl font-bold text-yellow-400">Content Warnings</h4>
          </div>
          <div className="flex flex-wrap gap-3">
      ...
      {getAvailableLanguages().length > 0 && (
        <div className="bg-blue-500/10 border border-blue-500/20 rounded-2xl p-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h4 className="text-xl font-bold text-blue-400">Available Languages</h4>
          </div>
      ...
      {contentData?.release_date && (
        <div className="bg-white/5 rounded-2xl border border-white/10 p-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h4 className="text-lg font-semibold text-white mb-1">Release Date</h4>
