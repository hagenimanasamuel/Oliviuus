...
export default function SupportNavTabs() {
  ...
  const tabs = useMemo(
    () => [
      ...
      { 
        id: "stats", 
        label: t("contactAdmin.tabs.statistics", "Statistics"), 
        icon: BarChart3, 
        component: <ContactStats /> 
      },
      { 
        id: "settings", 
        label: t("contactAdmin.tabs.contactSettings", "Contact Settings"), 
        icon: Settings, 
  ...
  return (
    <div className="w-full">
        ...
        {overflowTabs.length > 0 && (
          <div className="ml-auto relative" ref={moreButtonRef}>
            ...
            >
              ...
              <span>{t("contactAdmin.more", "More")}</span>
            </button>
      ...
      <div className="p-4 bg-gray-50 dark:bg-gray-900 rounded-lg min-h-[400px]">
        <Suspense fallback={<div className="text-gray-400">{t("contactAdmin.loading", "Loading...")}</div>}>
